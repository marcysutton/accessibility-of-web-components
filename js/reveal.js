...
var Reveal = (function(){
    ...
    SKIP_TO_NAV_LINK_SELECTOR = '#skip-to-toc',
	...
	function addEventListeners() {
		...
		[ 'touchstart', 'click', 'keypress' ].forEach( function( eventName ) {
	...
	/**
	 * Accessible div click adapter.
	 */
	function linkCheck(event) {
		// if user clicks or uses enter key, return true
	 ...
	 */
	function onNavigateLeftClicked( event ) { event.preventDefault(); if(linkCheck(event)){ navigateLeft(); } }
	function onNavigateRightClicked( event ) { event.preventDefault(); if(linkCheck(event)){ navigateRight(); } }
	function onNavigateUpClicked( event ) { event.preventDefault(); if(linkCheck(event)){ navigateUp(); } }
	function onNavigateDownClicked( event ) { event.preventDefault(); if(linkCheck(event)){ navigateDown(); } }
	function onNavigatePrevClicked( event ) { event.preventDefault(); if(linkCheck(event)){ navigatePrev(); } }
	function onNavigateNextClicked( event ) { event.preventDefault(); if(linkCheck(event)){ navigateNext(); } }
